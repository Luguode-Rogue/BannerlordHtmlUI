...
| 发布基线 | [RELEASE_GUIDE.md](RELEASE_GUIDE.md) | v0.44 及以后发布前收口 |
...
- `TROUBLESHOOTING.md`、`DEBUGGING.md`、`DIAGNOSTICS.md`：优先用于现场定位。
- `PROTOCOL.md`、`API.md`、`INPUT.md`、`LIFECYCLE.md`、`THREADING.md`：优先用于实现前确认契约。
- `CONSUMER_*.md`：用于实际 Consumer 接入与交付。
- `FRONTEND_*.md`：用于前端 Runtime 行为和绑定。
- `CHANGELOG_v*.md`：只作为历史证据，不作为当前规范的唯一来源。
